...
export default function navbar() {
  return (
    ...
    <div className='nav' id='ancre'>
        <Link to='acceuil'><img src={logo} className='logo'/></Link>
            <ul className='liste'>
            ...
            <button type='button' className='searchlogo'><img src={search}/></button>
            </div>
        <div className='icon'>
            <Link to='login'><img src={profile} className='img'/></Link>
            <Link to='#'><img src={favoris} className='img'/></Link>
            <Link to='#'><img src={panier} className='img'/></Link>
        </div>
    </div>
